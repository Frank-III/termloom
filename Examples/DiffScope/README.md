...
swift run ratatui-diffscope /path/to/repository

# Compare a checked-out pull-request head with its exact base commit:
swift run ratatui-diffscope --repo /path/to/repository --base BASE_SHA
```
