public enum TermLoomLogoSize: Hashable, Sendable {
  case tiny
  case small
}

public struct TermLoomLogo: Widget, Hashable, Sendable {
  public var size: TermLoomLogoSize

  public init(size: TermLoomLogoSize = .tiny) {
    self.size = size
  }
...
public struct TermLoomMascot: Widget, Hashable, Sendable {
